...
| `[supabase/migrations/](supabase/migrations/)` | SQL migrations—run **in filename order** in the Supabase SQL editor (`001` … `005`, then `006_security_hardening`). Skipping files often leads to **503** after login. |
